            ...
            <div>
                ...
                <ul>
                    <li><strong>Persiapkan Pembayaran Tunai:</strong> Pastikan Anda telah menyiapkan jumlah yang tepat
                        sesuai dengan total pembayaran yang tercantum dalam invoice yang telah kami tampilkan diatas.
                    </li>
                    <li><strong>Kunjungi Lokasi Pembayaran:</strong> Anda dapat melakukan pembayaran langsung di kantor
                        kami
                        yang berlokasi di:
                        <address>
                    ...
                    <li><strong>Konfirmasi Pembayaran:</strong> Setelah melakukan pembayaran, tim kami akan memberikan
                        bukti
                        pembayaran resmi. Simpan bukti ini sebagai referensi Anda.</li>
                </ul>
                <p>Jika Anda memerlukan bantuan lebih lanjut atau memiliki pertanyaan mengenai pembayaran, jangan ragu
                    untuk
                ...
                <p>Sekali lagi, terima kasih atas kepercayaan Anda berbelanja di CV. Lokal Industri. Kami berharap
                    produk
                    kami dapat memberikan manfaat dan kepuasan maksimal bagi Anda. Kami siap melayani kebutuhan Anda di
                    masa
                    mendatang.</p>
                <p>Salam hangat,</p>
                <p><strong>Tim CV. Lokal Industri</strong></p>
                <p>Apabila Anda memiliki masukan atau saran, kami sangat terbuka untuk mendengarnya. Kritik dan saran
                    Anda
                    membantu kami untuk terus meningkatkan pelayanan dan kualitas produk kami. Terima kasih dan sampai
                    jumpa
